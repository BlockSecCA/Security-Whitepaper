...
There is an upside for DAOs security assessments as blockchain technology enables audit functions to a greater degree than any other business enabling  technologies. 
...
Secure coding practices apply to all of the above, either in open source or closed source developments.

There new considerations for traditional practices for public blockchains:
* Applying corrective measures to defective code requires adoption by consensus
...
Smart contracts are on-chain code by means of a a programming language that execute functions directly against the blockchain defined assets, to create, destroy or re-allocate those assets.
